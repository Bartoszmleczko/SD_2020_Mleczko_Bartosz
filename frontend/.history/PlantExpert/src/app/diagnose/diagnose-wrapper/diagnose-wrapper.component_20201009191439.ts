...
export class DiagnoseWrapperComponent implements OnInit {
  ...
  buildRiskFactors(){
    ...
    riskFactorsArray = riskFactorsArray.concat(this.formData.riskFactors.values().next().value);
  ...
  submitSymptoms(){
      ...
      this.selectedSymptomsValues.forEach(v => console.log(v));
